...
{
    [DbContext(typeof(BillSharingDbContext))]
    [Migration("20260224033928_Add_Role_Into_GroupMember_Table")]
    partial class Add_Role_Into_GroupMember_Table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BillSharing.Expenses.Expense", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("BillSharing.Expenses.ExpenseItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppExpenseItems", (string)null);
                });

            modelBuilder.Entity("BillSharing.Expenses.ItemSplit", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ExpenseItemId", "UserId")
                        .IsUnique();

                    b.ToTable("AppItemSplits", (string)null);
                });

            modelBuilder.Entity("BillSharing.Groups.Group", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BillSharing.Groups.GroupMember", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BillSharing.Expenses.Expense", b =>
                {
                    b.HasOne("BillSharing.Groups.Group", null)
                        .WithMany("Expenses")
            ...
            modelBuilder.Entity("BillSharing.Expenses.ExpenseItem", b =>
                {
                    b.HasOne("BillSharing.Expenses.Expense", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("BillSharing.Expenses.ItemSplit", b =>
                {
                    b.HasOne("BillSharing.Expenses.ExpenseItem", null)
                        .WithMany("Splits")
            ...
            modelBuilder.Entity("BillSharing.Groups.GroupMember", b =>
                {
                    b.HasOne("BillSharing.Groups.Group", "Group")
                        .WithMany("Members")
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
